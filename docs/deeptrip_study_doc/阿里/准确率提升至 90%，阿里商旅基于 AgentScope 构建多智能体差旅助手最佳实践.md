![cover_image](./ali_agentscope_best_practice_assets/img_001.jpg)
...
![图片](./ali_agentscope_best_practice_assets/img_002.webp)
...
![图片](./ali_agentscope_best_practice_assets/img_003.png)
...
![图片](./ali_agentscope_best_practice_assets/img_004.png)
...
![图片](./ali_agentscope_best_practice_assets/img_005.png)
...
![图片](./ali_agentscope_best_practice_assets/img_006.png)
...
![图片](./ali_agentscope_best_practice_assets/img_007.png "AliGo Muiti Agent 架构-Level2 容器图")
...
![图片](./ali_agentscope_best_practice_assets/img_008.png)
...
![图片](./ali_agentscope_best_practice_assets/img_009.png "主智能体+意图识别智能体实现-Level3 组件图")
...
![图片](./ali_agentscope_best_practice_assets/img_010.png "第二阶段的主智能体+意图识别架构")

第二阶段的主智能体+意图识别架构

核心的设计在于主智能体的动态 Prompt 生成机制。主智能体（main\_plan\_agent）并不是简单地调用规则引擎或 LLM 意图识别，而是根据规则引擎的 classify() 结果动态选择不同的处理路径：
...
![图片](./ali_agentscope_best_practice_assets/img_011.png "流式输出+实时思考链实现-Level3 组件图")
...
**2. 订阅任务状态更新，具体为****监听**`task_update`**类型消息以实时渲染思考链**，并**监听**`text`**类型消息以展示最终回答**。

**3. 处理智能体执行结果，包括****收集最终回答内容**和**维护卡片数据与任务的映射关系**。

4. 最后，**构建结构化的最终响应**并**生成符合 SSE 格式的输出流**。
...
![图片](./ali_agentscope_best_practice_assets/img_012.png "上下文工程-Level3 组件图")
...
![图片](./ali_agentscope_best_practice_assets/img_013.png "会话记忆架构-Level3 组件图")
...
![图片](./ali_agentscope_best_practice_assets/img_014.png "记忆分层与共享-Level3 组件图")
...
![图片](./ali_agentscope_best_practice_assets/img_015.png "事项收集智能体（工程与智能体结合实践）-Level3 组件图")
...
![图片](./ali_agentscope_best_practice_assets/img_016.png)
...
![图片](./ali_agentscope_best_practice_assets/img_017.png "知识库架构图")
...
![图片](./ali_agentscope_best_practice_assets/img_018.png)

**选型结论**：经综合评估，Langfuse 在**开源透明**、**数据安全**、**成本控制**和**可扩展性**方面具有更具优势，完全满足商旅 Saas + 本地化部署的诉求，是构建可控、可靠的 LLM 应用监控平台的最佳选择。

### 2. 架构设计

![图片](./ali_agentscope_best_practice_assets/img_019.png "观测平台架构图")
...
![图片](./ali_agentscope_best_practice_assets/img_020.png "测评平台架构图")
...
![](./ali_agentscope_best_practice_assets/img_021.png)
...
![跳转二维码](./ali_agentscope_best_practice_assets/img_022.png)

![作者头像](./ali_agentscope_best_practice_assets/img_021.png)

微信扫一扫可打开此内容，
使用完整服务

![](./ali_agentscope_best_practice_assets/img_023.png)
...
![划线引导图](./ali_agentscope_best_practice_assets/img_024.png)
